 ...
 */
final class Version20220929082150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE user_id owner_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DADD4A257E3C61F9 ON answer');
        $this->addSql('ALTER TABLE answer CHANGE owner_id user_id INT DEFAULT NULL');
